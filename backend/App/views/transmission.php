                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12 m-auto text-center">
                                        ...
                                        <section id="iframe_1_section">
                                            <iframe class="frame-transmision" src="<?php echo $transmision_1['url']; ?>" allow="fullscreen;" frameborder="0"></iframe>
                                        </section>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12 m-auto text-center">
                                        ...
                                        <section id="iframe_2_section">
                                            <iframe class="frame-transmision" src="<?php echo $transmision_2['url']; ?>" allow="autoplay; fullscreen;" frameborder="0"></iframe>
                                        </section>
