                ...
                <div class="row mt-4">
                    <div class="col-10 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <input type="hidden" name="t_url_1" id="t_url_1" value="<?=$transmision_1['url']?>">
                                    <input type="hidden" name="t_url_2" id="t_url_2" value="<?=$transmision_1['url_2']?>">
                ...
                <div class="row mt-4">
                    <div class="col-10 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                <input type="hidden" name="t2_url_1" id="t2_url_1" value="<?=$transmision_2['url']?>">
                                    <input type="hidden" name="t2_url_2" id="t2_url_2" value="<?=$transmision_2['url_2']?>">
                                    <div class="col-12 col-md-12 m-auto text-center">
                                        <!-- <img alt="Image placeholder" style="width: 100%" src="https://images.unsplash.com/photo-1552581234-26160f608093?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2100&q=80" class="img-fluid border-radius-lg shadow-lg"> -->
                                ...
                                <!-- <button id="btn_traduccion_transmision_2_ingles" class="btn bg-gradient-success mb-0 ms-2 mt-4">Traducir al Ingles</button>
                                <button id="btn_traduccion_transmision_2_esp" class="btn bg-gradient-success mb-0 ms-2 mt-4" style="display: none;">Traducir al Español</button> -->
...
<script>
    ...
    function intervalo1() {
        intervalo = setInterval(chats, 60000, 5, 1);
    }
    ...
    $(document).ready(function() {
        ...
        //     $("#btn_traduccion_transmision_1_esp").css("display", "block");
        // });
        ...
        //     $(this).css("display", "none");
        //     $("#btn_traduccion_transmision_1_ingles").css("display", "block");
        ...
        $(".form-switch").on("click","button#btn_traduccion_transmision_1_ingles",function(){
            ...
            if(url_ingles_existe_imagen_jpg || url_ingles_existe_imagen_png){


                $("#iframe_1_section").html(`<img id="img-stanby-1" class="frame-transmision" src="${url_ingles}" alt="">`);               
                $(this).css("display", "none");
                $("#btn_traduccion_transmision_1_esp").css("display", "block");            
            }else{
                // $("#iframe_transmision_1").attr('src',url_ingles);  
                $("#iframe_1_section").html(`<iframe class="frame-transmision" id="iframe_transmision_1" src="${url_ingles}" allow="autoplay; fullscreen;" frameborder="0" ></iframe>`);              
                $(this).css("display", "none");
                $("#btn_traduccion_transmision_1_esp").css("display", "block");
            }
        ...
        $(".form-switch").on("click","button#btn_traduccion_transmision_1_esp",function(){
            ...
            // $("#iframe_transmision_1").attr('src',url_esp);
            $("#iframe_1_section").html(`<iframe class="frame-transmision" id="iframe_transmision_1" src="${url_esp}" allow="autoplay; fullscreen;" frameborder="0" ></iframe>`);
            $(this).css("display", "none");
            $("#btn_traduccion_transmision_1_ingles").css("display", "block");
        ...
        $("#transmision_2").on("click","button#btn_traduccion_transmision_2_ingles",function(){
            var url_ingles = $("#t2_url_2").val();

            $("#iframe_transmision_2").attr('src',url_ingles);
            $(this).css("display", "none");
            $("#btn_traduccion_transmision_2_esp").css("display", "block");
            
        });

        $("#transmision_2").on("click","button#btn_traduccion_transmision_2_esp",function(){
            var url_esp = $("#t2_url_1").val();

            $("#iframe_transmision_2").attr('src',url_esp);
            $(this).css("display", "none");
            $("#btn_traduccion_transmision_2_ingles").css("display", "block");
