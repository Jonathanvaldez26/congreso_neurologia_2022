                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show position-relative active border-radius-lg" id="m_18" role="tabpanel" aria-labelledby="m_18">
                        ...
                        <p class="">Nota: Si usted desea visualizar el documento de clic sobre el nombre del trabajo libre.</p>
                            <div class="row mt-3">
                                    <?php echo $card_trabajos_libres_grupo2; ?>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade position-relative border-radius-lg" id="m_21" role="tabpanel" aria-labelledby="m_21">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row">
                                <div class="button-row d-flex mt-4 col-12">
                                    <a class="btn bg-gradient-light mb-0 js-btn-prev" href="/trabajos_libres_grupo2/" title="Prev">Regresar</a>
                                </div>
                            </div>
                        </div>
                    </div>
