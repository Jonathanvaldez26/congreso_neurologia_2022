                ...
                <div class="card card-body" id="profile">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
                            <a href="/Talleres/" class="mt-2 me-2 btn-move">
                                        ...
                                        <div class="nav-wrapper position-relative end-0">
                                            ...
                                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                                <li class="nav-item transmisiones px-3" data-transmision="1">
                                                    <a class="nav-link mb-0 px-0 py-1" href="#m_18" data-bs-toggle="tab" role="tab" aria-selected="true">
                                                        <span class="fa fa-calendar"></span>
                                                        <span class="ms-1">18 de mayo</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item transmisiones px-3" data-transmision="2">
                                                    <a class="nav-link mb-0 px-0 py-1 active" href="#m_19" data-bs-toggle="tab" role="tab" aria-selected="false">
                                                        <span class="fa fa-calendar"></span>
        ...
        <div class="row mt-0 m-auto">
            ...
            <div class="card col-lg-10 mt-lg-3 mt-1">
                <div class="tab-content" id="v-pills-tabContent">
                    <!-- <div class="tab-pane fade position-relative border-radius-lg" id="m_18" role="tabpanel" aria-labelledby="m_18">
